...
census <- function(year = 2022, num_var = c("AGEP", "PWGTP"), cat_var = "SEX", geog, spec = NULL) {
  ...
  #checking for valid geographical levels & subsets depending on level selected
