...
Creating the census summary function that will produce means and standard deviations numeric variables as well as counts for categorical variables.
...
summary.census <- function(tibble, num_var = NULL, cat_var = NULL){
  ...
  #Defining numeric variables to summarize
  if (is.null(num_var)) {
    ...
    if (length(numeric_vars) == 0) {
      stop("Error: NO numeric variables found to summarize")
    }
    
  } else {
  
    #Numeric Variables were specificed by user 
    #Do the numeric variables exist?
    ...
    #If pass all the above checks then use
